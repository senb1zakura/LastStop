            ...
            children: [
              ...
              Align(
                ...
                child: Container(
                  ...
                  child: const Center(
                    child: Text('LS', style: TextStyle(color: Colors.white)),
                  ),
                ),
              ),
              ...
              Row(
                children: [
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          target?.name ?? 'Select stop',
                          style: const TextStyle(color: Colors.black87),
                        ),
                        if (penultimate != null)
                          Text(
                            'Предпоследняя: ${penultimate.name}',
                  ...
                  AlarmToggle(
                    value: _modeTimeStop,
                    onChanged: (v) => setState(() => _modeTimeStop = v),
                  ),
                ],
              ),
                  ...
                  itemBuilder: (context, idx) {
                    ...
                    return StopTile(
                      ...
                      onTap: () {
                        ...
                        _alarm.setEnabled(true); // 🔥 ТОЛЬКО ЭТО
                      },
                    );
                  },
                ),
              ...
              Row(
                ...
                children: [
                  Text(
                    'Текущая: ${_stops[currentIndex].name}',
